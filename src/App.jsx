...
function App() {
    const [page, setPage] = useState(<MainProps />);
        ...
        <div className="main">
            <div className="head">
                ...
                <form className="search_main" onSubmit={
                    (e) => {
                        e.preventDefault();
                        setPage(<SearchProps text={document.getElementsByClassName('search_field')[0].value} />)
                    }
                }>
                    <input className="search_field" />
                    <img className="search_img" src={imgGlass} onClick={() => setPage(<SearchProps text={document.getElementsByClassName('search_field')[0].value} />)} />
                </form>
